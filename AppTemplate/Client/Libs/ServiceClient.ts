...
export class EntryPointResult {
    ...
    public getLoggedIn(): Promise<EntryPointResult> {
        return this.client.LoadLink("GetLoggedIn")
               .then(r => {
                    return new EntryPointResult(r);
                });
    ...
    public canGetLoggedIn(): boolean {
        return this.client.HasLink("GetLoggedIn");
    }

    public linkForGetLoggedIn(): hal.HalLink {
        return this.client.GetLink("GetLoggedIn");
    }

    public getGetLoggedInDocs(query?: HalEndpointDocQuery): Promise<hal.HalEndpointDoc> {
        return this.client.LoadLinkDoc("GetLoggedIn", query)
            .then(r => {
                return r.GetData<hal.HalEndpointDoc>();
            });
    }

    public hasGetLoggedInDocs(): boolean {
        return this.client.HasLinkDoc("GetLoggedIn");
    }
